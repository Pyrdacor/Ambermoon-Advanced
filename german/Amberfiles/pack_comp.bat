...
start "" AmbermoonPack.exe AMNP Floors Floors.amb -d1 -c3
start "" AmbermoonPack.exe AMPC Palettes Palettes.amb -d4

start "" AmbermoonTextManager.exe -i . AllTexts -f 1Map_texts.amb -c
start "" AmbermoonTextManager.exe -i . AllTexts -f 2Map_texts.amb -c
start "" AmbermoonTextManager.exe -i . AllTexts -f 3Map_texts.amb -c
start "" AmbermoonTextManager.exe -i . AllTexts -f NPC_texts.amb -c
start "" AmbermoonTextManager.exe -i . AllTexts -f Object_texts.amb -c
start "" AmbermoonTextManager.exe -i . AllTexts -f Party_texts.amb -c
start "" AmbermoonTextManager.exe -i . AllTexts -f Text.amb -c
